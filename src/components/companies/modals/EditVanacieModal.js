...
const EditVanacieModal = () => {
  ...
  const m = modalidades;
  return (
    <div className="modal fade" id="staticBackdropEditVanacie" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h1 className="modal-title fs-5" id="staticBackdropLabel">Editar Vacante</h1>
