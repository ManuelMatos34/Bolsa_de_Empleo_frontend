            ...
            {loading !== 1 ? (
                <div className="card-body">
                    ...
                    <div className="overflow-auto" style={{ maxHeight: "50vh" }}>
                        <h6 className="card-subtitle mb-2 mt-1 text-muted"><i className="fas fa-info-circle"></i> Descripción</h6>
                        <p className="card-text">
                            {dataDescription.Job_Description}
                        </p>
                        <h6 className="card-subtitle mb-2 text-muted"><i className="fas fa-check-circle"></i> Requerimientos</h6>
                        <p className="card-text">
