...
const AddSkillsModal = ({ handleChange, formData }) => {
    const formFields = [
        { label: 'Nombre de la Habilidad', id: 'Skill', type: 'text', maxLength: '25', required: true, value: formData.Skill, },
        { label: 'Carrera', id: 'Ca_ID', type: 'select', required: true, value: formData.Ca_ID, },
    ];
                ...
                <div className="modal-content">
                    ...
                    <form onSubmit={handleAddSkill}>
                                ...
                                <div className="mb-3" key={field.id}>
                                    ...
                                    {field.type === 'select' ? (
                                        ...
                                        >
                                            ...
                                            <option value="7">Lic. en Educación, mención Educación Especial</option>
                                            <option value="8">Lic. en Matemática Orientada a la Educación Secundaria</option>
                                            <option value="9">Lic. en Química Orientada a la Educación Secundaria</option>
                                            <option value="10">Lic. en Física Orientada a la Educación Secundaria</option>
                                            ...
                                            <option value="20">Ingeniería en Sistemas Computacionales</option>
                                            <option value="21">Lic. en Derecho</option>
                                            <option value="22">Ingeniería Agronómica mención Cultivos</option>
                                            <option value="23">Dr. en Veterinaria</option>
                                            <option value="24">Lic. en Administración de Empresas</option>
                                            <option value="25">Lic. en Mercadeo</option>
                                            <option value="26">Lic. en Administración Hotelera y Turística</option>
                                            <option value="27">Lic. en Contabilidad y Auditoria</option>
                                        </select>
                                    ) : (
                                        <input
                                            type={field.type}
                        ...
                        <div className="modal-footer">
                            ...
                            <button style={{ backgroundColor: "#0C4770", borderColor: "#0C4770" }} type="submit" className="btn btn-primary btn-sm">Agregar</button>
                        </div>
                    </form>
                </div>
            </div>
